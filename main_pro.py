    ...
    if uploaded_file:
        ...
        if st.button("Convert"):
            with st.spinner("Extracting Information..."):
                ...
                # Disable OCR + external plugins manually
                try:
                    loader.converter.pipeline_options.do_ocr = False
                    loader.converter.pipeline_options.allow_external_plugins = False
                except:
                    pass   # For versions where pipeline_options is not present
